...
import { HeroSeam } from "./_components/HeroSeam";
import { TrustBand } from "./_components/TrustBand";
import { AssemblyStack } from "./_components/AssemblyStack";
import { CertifyPlot } from "./_components/CertifyPlot";
import { RangeLedger } from "./_components/RangeLedger";
import { CategoryBrowse } from "./_components/CategoryBrowse";

// ─────────────────────────────────────────────────────────────────────────────
// HOMEPAGE DRAFT — "The Seam"  (owner: John)
//
// The synthesized winner of the 2026-06-12 client review, built out to every
// request we could accommodate. Section order is tuned for FLOW — hook → payoff
// → proof → breadth → explore → authority → act (the hero's chips carry the
// "trust up front" signal, so the full trust band moves down to reassure right
// before the ask). Sections alternate tone (lift/recess) with hairline borders
// so each reads as its own plate, not one long navy scroll:
//
...
// Everything degrades to a static, fully-readable layout under no-JS / reduced
// motion. Preview at /home-seam.
// ─────────────────────────────────────────────────────────────────────────────
...
export default function HomeSeam() {
