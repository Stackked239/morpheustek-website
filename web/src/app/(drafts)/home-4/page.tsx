...
// ─────────────────────────────────────────────────────────────────────────────
// HOMEPAGE DRAFT — Variant 4  (owner: Austin)
//
// Blank canvas. Build this homepage iteration here; preview at /home-4.
...
export const metadata: Metadata = {
  title: "Homepage draft — Variant 4",
...
export default function HomeVariant4() {
  return (
    <section className="mt-container flex min-h-[60vh] flex-col justify-center py-24">
      ...
      <h1 className="mt-3 font-display text-h1 font-bold text-text-strong">Variant 4</h1>
