...
// Illustrative 2026 schedule — confirm exact dates/booths before publishing.
const shows = [
    ...
    <>
      ...
      <Section>
        <Container>
            ...
            {shows.map((s) => (
              <div key={s.name} className="surface-card flex flex-col p-6">
                <div className="flex items-center justify-between">
                  ...
                  {s.next ? <Badge tone="new">Next up</Badge> : null}
                </div>
          ...
          <p className="mt-8 font-mono text-xs text-text-subtle">Schedule updates through the year — confirm exact dates and booth numbers before you travel.</p>
        </Container>
      </Section>
